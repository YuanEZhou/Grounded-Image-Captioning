...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='/home/yuanen/self-critical.pytorch/data/dataset_flickr30k.json', help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default='/home/yuanen/self-critical.pytorch/data/flickrtalk.json', help='output json file')
  parser.add_argument('--output_pkl', default='/home/yuanen/self-critical.pytorch/data/flickr-train', help='output pickle file')
