...
parser.add_argument('--image_root', type=str, default='/data2/yuanen/data/datasets/flickr30k/flickr30k-images', 
...
parser.add_argument('--eval_att', type=int, default=0,
                    help='whether evaluate attention accuracy')
parser.add_argument('--gt_grd_eval', type=int, default=0,
                    help='evaluate grounding accuracy on gt sentence.')
parser.add_argument('--eval_scan', type=int, default=0,
